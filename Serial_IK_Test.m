...
t06=[ 0.0887   -0.8376    0.5390  275.5386;
   -0.9539   -0.2272   -0.1962 -100.2879;
    0.2868   -0.4967   -0.8192   35.2673;
         0         0         0    1.0000];
...
b=(l2*sin(Q3*pi/180))/(l1+l2*cos(Q3*pi/180));
theta1=atan(a);
theta2=pi-theta1;
alpha1=atan(b);
q21=theta1-alpha1;
...
if Q2<0 || Q2>150
    Q2=q22*180/pi;
end         %% Q2= 0< (q21 or q22 or q23 or q24)*180/pi < 150
